...
// Render pode emitir certificados por Google Trust Services ou Let's Encrypt.
// Este bundle inclui as raizes GTS/GlobalSign e ISRG usadas por essas cadeias.
// O ESP32 valida hostname, assinatura e validade; nao use setInsecure().
static const char AGROGUARDIAN_TLS_ROOT_CA[] PROGMEM = R"AGRO_CA(-----BEGIN CERTIFICATE-----
